...
const TERMS: Record<string, Term[]> = {
  ...
  FIR_REFUSED: [
    ...
    { w: 'wouldn\'t take my complaint', p: 3 },
    { w: 'would not take my complaint', p: 3 },
    { w: 'won\'t take my complaint', p: 3 },
    { w: 'refused to take my complaint', p: 3 },
    { w: 'refuse to take my complaint', p: 3 },
    { w: 'take my complaint', p: 2 },
  ...
  SEARCH: [
    ...
    { w: 'look through my bag', p: 3 },
    { w: 'go through my bag', p: 3 },
    { w: 'look through my', p: 2 },
    { w: 'go through my', p: 2 },
    { w: 'searching my', p: 3 },
    { w: 'तलाशी', p: 3 },
    { w: 'तलाश', p: 2 },
